...
public class LogAspect {
	...
	public Object afterReturningLog(JoinPoint joinPoint, String message) {
		...
		System.out.println("[Log: AfterReturning] 메소드 리턴값: " + message);
		return message;
	}
	...
	public void AfterThrowingLog(JoinPoint joinPoint, Exception exception) {
		...
		System.out.println("[Log: AfterThrowing] 메소드 리턴값: " + exception.getMessage());
	}
	
	@Around("execution(* com.sample..*.*(..))")
	public Object trace(ProceedingJoinPoint joinPoint) throws Throwable {
		Signature signature = joinPoint.getSignature();
		System.out.println("[Log: Around]Before 메소드 이름: " + signature.getName() + "time check start!");
		...
		System.out.println("[Log: Around]After 메소드 이름: " + signature.getName() + "time check end!");

		System.out.println("[Log: Around] " + signature.getName() + "Processiong time is " + (endTime - startTime) + "ns");
		return result;
	}
